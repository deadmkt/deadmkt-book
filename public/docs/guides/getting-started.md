...
Ready? Follow the [Run a Node](guides/run-a-node.md) guide for detailed instructions.

Want to understand the protocol first? Read the [Protocol Overview](protocol/overview.md).

Want to see why this exists? Read the [Manifesto](manifesto.md).
